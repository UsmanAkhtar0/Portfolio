...
const projects = [
  { name: "Shopify", description: " Developed and deployed a full-stack e-commerce platform with secure authentication (JWT, bcrypt), advanced product search, detailed product pages, and a fully responsive UI. Built with MERN stack and MongoDB Atlas, and deployed on Render for scalability.", image: "/Portfolio/images/Shopify.png", link: "https://shopify-8a08.onrender.com/products", link2: "https://github.com/UsmanAkhtar0/Shopify.git" },
  { name: "ZoMeet", description: "ZoMeet is a real-time video conferencing application, built with WebRTC, React, and Socket.IO, that enables seamless peer-to-peer video calls, chat, and collaboration. It focuses on low-latency communication, secure connections, and an intuitive user interface for smooth virtual meetings.", image: "/Portfolio/images/ZoMeet.png", link: "https://zomeetfrontend.onrender.com/", link2: "https://github.com/UsmanAkhtar0/ZoMeet.git" },
